  ...
  function exploreSteps() {
    return [
      ...
      { title: 'Choose a detrending method', target: '#railDetrend',
        onEnter: function () { var d = document.getElementById('railExtra'); if (d) d.open = true; },
        body: 'Detrending lives under <b>Additional settings</b>. It removes each series\' slow age-related growth trend so only the year-to-year climate signal — the part that crossdates — remains. The default <b>spline</b> works well for most datasets; the window controls how stiff the fitted curve is.' },
